 ...
 * A class that can perform functions on any collection of inputs, with or without a comparator input
...
public class SimplePriorityQueue<E> implements PriorityQueue {
	 ...
	 * Constructor for SimplePriorityQueue if no comparator is input by user
	 ...
	 * Constructor for SimplePriorityQueue if a comparator is input by user
